...
using HubCrawl.WPF.Services;


namespace HubCrawl.WPF.ViewModels
{
    public class PanoramaTileViewModel : NotifyPropertyChangedBase, HubCrawl.WPF.Controls.IPanoramaTile
    {
        ...
        public PanoramaTileViewModel(IMessageBoxService messageBoxService, string text, string imageUrl, bool isDoubleWidth)
        {
            ...
            this.TileClickedCommand = new HubCrawl.WPF.Controls.SimpleCommand<object, object>(ExecuteTileClickedCommand);
        }
